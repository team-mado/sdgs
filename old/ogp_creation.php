...
// 初期画面/
if(!isset($_GET["id"])){
  $img = "https://res.cloudinary.com/dlqadjcsc/image/upload/l_text:Sawarabi%20Gothic_30_bold:下記のフォームを全て全て入力いただくと%0Aこちらの枠内にバナーが生成されます,co_rgb:333,w_500,c_fit/v1616471824/UbpRDEkE_uqbs0d.png";
}
  ...
  <body>
    ...
    <main>
      ...
      <form action="ogp_act.php" method="post" class="row">
        ...
        <!-- <input class="form-style" id="GET-name" type="text" name="project_overview" value="" /> -->
        <!-- <input class="form-style" id="GET-name" type="text" name="project_overview" value="<? echo($project_overview) ?>" /> -->
        <input class="form-style" id="GET-name" type="text" name="project_overview" value="改行ゴミを洋服に変える。FASIONxSEAプロジェクト" />
                <label for="GET-name">詳細</label><br>
                <!-- <input class="form-style" id="GET-name" type="text" name="detail" value=""/> -->
        <!-- <input class="form-style" id="GET-name" type="text" name="detail" value="<? echo($detail) ?>"/> -->
        <input class="form-style" id="GET-name" type="text" name="detail" value="海のゴミから布を布を作り、洋服へ"/>

                <label for="GET-name">制作期間</label><br>
        <!-- <input class="form-style" id="GET-name" type="text" name="production_period" value="" /> -->
        <!-- <input class="form-style" id="GET-name" type="text" name="production_period" value="<? echo($production_period) ?>" /> -->
        <input class="form-style" id="GET-name" type="text" name="production_period" value="testtest" />
                <label for="GET-name">
