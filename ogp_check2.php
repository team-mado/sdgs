...
<a href="ogp_update2.php?id=<? echo($id) ?>"><img src="img/bt-hensyu.png" alt=""><input type="submit" value="" /></a>
<a href="project_recruiting.php?id=<? echo($id) ?>">test</a>
<!-- <a href="https://twitter.com/intent/tweet?text=グラフィックデザイナー募集中?url=project_recruiting.php?id=<? echo($id) ?>"><img src="img/bt-tweet.png" alt=""></a> -->
...
<br>
    <div class="center">
    <form action="project_list2.php" method="post" enctype="multipart/form-data">
